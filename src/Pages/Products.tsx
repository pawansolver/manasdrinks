...
const products = [
    {
        ...
        modelPath: '/Products/monster_energy_drink.glb', modelGlowColor: '#90EE90', scale: [0.3, 0.3, 0.3], position: [0.01, -0.6, 0.2], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/pink.glb', modelGlowColor: '#ff69b4', scale: 0.04, position: [0, -0.5, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/orange.glb', modelGlowColor: '#ff8c00', scale: 8, position: [0, -0.6, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/monster_zero_ultra.glb', modelGlowColor: '#B0B0B0', scale: 0.34, position: [0, -0.5, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/palladium_energy_drink.glb', modelGlowColor: '#ff0000', scale: 0.1, position: [0, -0.6, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/red_bull_energy_drink_can.glb', modelGlowColor: '#ff1493', scale: 15.4, position: [0.08, -0.2, 0], camera: [0, 0, 4.5],
    },
    {
        ...
        modelPath: '/Products/lit.glb', modelGlowColor: '#00d8ff', scale: 0.8, position: [0, -0.7, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/black_monster_energy_drink.glb', modelGlowColor: '#50C878', scale: 6.35, position: [0, 0.01, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/guoba_chili_energy_drink.glb', modelGlowColor: '#D22B2B', scale: 0.35, position: [0, -0.7, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/kendu_energy_drink_can.glb', modelGlowColor: '#32CD32', scale: 1.6, position: [0, -0.7, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/palladium_energy_drink.glb', modelGlowColor: '#C0C0C0', scale: 0.08, position: [0, -0.6, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/energy_drink_500ml.glb', modelGlowColor: '#FFD700', scale: 8.2, position: [0, -0.7, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/energy_drink_game_ready_model.glb', modelGlowColor: '#00FF7F', scale: 0.06, position: [0, -0.8, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/gla.glb', modelGlowColor: '#1E90FF', scale: 7.25, position: [0, -0.6, 0], camera: [0, 0, 3],
    },
    {
        ...
        modelPath: '/Products/energy_drink.glb', modelGlowColor: '#FFFF00', scale: 0.15, position: [0, -0.6, 0], camera: [0, 0, 3],
    },
];
...
const AnimatedCan = React.memo(({ config }: AnimatedCanProps) => {
...
const ProductScene = React.memo(({ config, controls = true }: ProductSceneProps) => (
    ...
    <>
      <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 md:space-x-8 p-6 bg-neutral-900 border border-neutral-800 rounded-2xl shadow-xl shadow-lime-500/5 relative overflow-hidden">
        ...
        <div className="w-48 h-48 md:w-56 md:h-56 flex-shrink-0 overflow-hidden">
          <MotionDiv
            className="w-[264px] h-52 rounded-xl overflow-hidden border border-white/20 shadow-lg shadow-green-500/20"
      ...
      <AnimatePresence>
        {showNotification && (
          <MotionDiv className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm z-50" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <MotionDiv initial={{ scale: 0.8, opacity: 0, y: 50 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.8, opacity: 0, y: 50 }} transition={{ type: "spring", stiffness: 100, damping: 15 }} className="bg-neutral-900 border border-lime-400/30 rounded-2xl p-8 text-center max-w-sm mx-auto shadow-xl shadow-lime-400/10">
...
const AccordionItem = ({ title, children, defaultOpen = false }: AccordionItemProps) => {
  ...
  return (
    <div className="border-t border-neutral-700">
      ...
      <AnimatePresence>
        {isOpen && (
          <MotionDiv initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.3, ease: 'easeInOut' }} className="overflow-hidden">
...
const ProductDetailPage = () => {
  ...
  const product = useMemo(() => products.find(p => p.id === Number(idStr)), [idStr]);
...
const ProductsHome = () => {
  ...
  const [filters, setFilters] = useState<ProductFilters>({ flavors: [], types: [], packSizes: [], price: null });
